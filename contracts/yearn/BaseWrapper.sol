...
abstract contract BaseWrapper {
    ...
    function _withdraw(
                ...
                if (amount != WITHDRAW_EVERYTHING) {
                    ...
                    * (10**uint256(vaults[id].decimals()))
                    ...
                    if (
                        ...
                        withdrawn += vaults[id].withdraw(estimatedShares);
                    } else {
                        withdrawn += vaults[id].withdraw(availableShares);
                    }
                } else {
        ...
        if (
            withdrawn > amount &&
            withdrawn - amount > _bestVault.pricePerShare() / (10**_bestVault.decimals())
        ) {
