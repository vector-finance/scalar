...
<<<<<<< HEAD:contracts/tokens/YearnAffiliateToken.sol
import "../yearn/interfaces/VaultApi.sol";
import {BaseWrapper} from "../utils/BaseWrapper.sol";
=======
import "./interfaces/VaultApi.sol";
import {BaseWrapper} from "./BaseWrapper.sol";
>>>>>>> 6f90836643e4e00f9066b7b308e17cac531b3e4a:contracts/yearn/AffiliateToken.sol
...
contract YearnAffiliateToken is ERC20, BaseWrapper {
    ...
    function _sharesForValue(uint256 amount) internal view returns (uint256) {
        ...
        // for avoiding subtraction overflow error
